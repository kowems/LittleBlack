...
public class CameraFragment extends Fragment
    ...
    private CameraCaptureSession.CaptureCallback mCaptureCallback
        ...
        private void process(CaptureResult result) {
            //Log.d("mCaptureCallback","mState:" + mState);
            switch (mState) {
                case STATE_PREVIEW: {
                ...
                case STATE_WAITING_LOCK: {
                    ...
                    Log.d("mCaptureCallback","afState:" + afState);
                    if (afState == null) {
                        captureStillPicture();
                    }
                    //else if (CaptureResult.CONTROL_AF_STATE_FOCUSED_LOCKED == afState ||
                     //       CaptureResult.CONTROL_AF_STATE_NOT_FOCUSED_LOCKED == afState) {
                        ...
                        // TODO 增加超时机制   -----    开始对焦后，启动定时器，超时后，停止本次对焦并再次启动对焦请求
                        //abortCaptures();
                    break;
                }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        // Eric Ju mFile = new File(getActivity().getExternalFilesDir(null), "pic.jpg");
    }
    ...
    private void captureStillPicture() {
        try {
            ...
            captureBuilder.set(CaptureRequest.CONTROL_AF_MODE,
                    CaptureRequest.CONTROL_AF_MODE_CONTINUOUS_PICTURE);
            // Eric Ju setAutoFlash(captureBuilder);
